...
Exploratory Spatial Data Analysis (ESDA) hold tremendous potential to address complex problems facing society. In this study, I will demonstrate how to apply appropriate Local Indicators of Spatial Association (GLISA) and Emerging Hot Spot Analysis (EHSA) to undercover the spatial and spatio-temporal mobility patterns of public bus passengers in Singapore.
...
tm_shape(mpsz_origtrip)+
  ...
  tm_layout(main.title = "Passenger trips generated by origin at the hexagon level",
...
### **6.1.1 Creating a Time Series Cube**

Convert "Year-month" in odbus

```{r}
odbus_updated <- odbus %>% 
  mutate(date_as_date = as.Date(paste0(YEAR_MONTH, "-01")))
